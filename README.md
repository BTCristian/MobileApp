...
This app is built with React Native for seamless user experiences, Animatable for captivating animations, and integrated with the dependable backend systems of Appwrite,
...
```bash
git clone https://github.com/BTCristian/MobileApp.git
cd aora
```
